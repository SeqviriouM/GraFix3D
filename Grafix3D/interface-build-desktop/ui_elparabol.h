...
public:
    ...
    void setupUi(QDialog *elparabol)
    {
        ...
        widget = new QWidget(elparabol);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(40, 430, 491, 29));
    ...
    void retranslateUi(QDialog *elparabol)
    {
        ...
        pushButton_7->setText(QApplication::translate("elparabol", "PushButton", 0, QApplication::UnicodeUTF8));
