...
giperbola::giperbola(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::giperbola)
{
    ui->setupUi(this);
...
void giperbola::skryt()
{
    ui->scrollArea_2->setHidden(true);
}

void giperbola::vmenu()
{
